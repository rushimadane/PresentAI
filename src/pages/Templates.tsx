    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow pt-24 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
            <h1 className="text-3xl font-semibold mb-3">Starter templates</h1>
            <p className="text-lg text-gray-600 max-w-2xl">
              Pick a starting point instead of a blank page. Each template opens a deck you can edit or regenerate.
            </p>
          </div>
